  ...
  const services = [
    {
      ...
      subtitle: 'Complete pest protection with quarterly service',
      price: '$120',
    ...
    },
    {
      ...
      subtitle: 'Emergency response when you need it most',
      price: '$225',
      interval: 'one-time',
      icon: <Zap className="w-10 h-10" />,
      description: 'Urgent pest control response for immediate issues with guaranteed same-day results.',
      features: [
        'Same-day response',
        'Emergency treatment',
        'Targeted solutions',
    ...
    },
    {
      ...
      subtitle: 'Humane wildlife removal and prevention',
      price: 'Free',
      interval: 'estimate',
      icon: <Target className="w-10 h-10" />,
      description: 'Professional wildlife removal with humane methods and long-term prevention strategies.',
      features: [
        'Free inspection',
        'Humane removal',
        'Entry prevention',
    ...
    },
    {
      ...
      subtitle: 'Termite and wood-destroying insect treatment',
      price: 'Custom',
      interval: 'pricing',
      icon: <Bug className="w-10 h-10" />,
      description: 'Specialized treatment for termites and wood-destroying insects with advanced protection.',
      features: [
        'Thorough inspection',
        'Treatment plan',
        'Baiting systems',
