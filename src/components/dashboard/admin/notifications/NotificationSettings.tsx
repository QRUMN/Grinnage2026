      ...
      <div className="p-4 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="p-2 bg-mint-100 dark:bg-mint-900/30 rounded-lg">
              <AlertTriangle className="w-5 h-5 text-mint-500" />
            </div>
            <div>
              <p className="font-medium text-dark-900 dark:text-white">System Alerts</p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-dark-900 dark:text-white">SMS Alerts</p>
              <p className="text-sm text-dark-600 dark:text-dark-400">
                Get alerts via SMS
              </p>
            </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-dark-900 dark:text-white">Browser Notifications</p>
              <p className="text-sm text-dark-600 dark:text-dark-400">
